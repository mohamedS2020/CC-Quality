    ...
    <div style={{ display: "grid", gap: "1.75rem" }}>
      <header>
        <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", flexWrap: "wrap" }}>
          ...
          <span className="badge">Version {config.version}</span>
          {config.isActive && <span className="badge badge-success">Active</span>}
        </div>
      ...
      <section>
        ...
        {config.lenses.length === 0 ? (
          <p className="muted">No lenses configured.</p>
        ) : (
            ...
            {config.lenses.map((lens) => (
              <div key={lens.id} className="card">
                ...
                >
                  ...
                  {isLensProvisional(lens.basis) && (
                    <span className="badge badge-accent">provisional</span>
                  )}
                </div>
                <ul style={{ margin: "0.5rem 0 0", paddingLeft: "1.1rem", fontSize: "0.9rem" }}>
                  ...
                  {lens.benchmarks.size === 0 && <li className="muted">No benchmarks.</li>}
                </ul>
              </div>
            ))}
          </div>
